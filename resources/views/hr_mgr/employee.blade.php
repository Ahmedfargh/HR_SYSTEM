                ...
                <div class="card-body">
                    <form action="{{route('register_employee')}}" method="post"class="row">
                        ...
                        <div class="input-group col-4">
                            <input type="text" class="form-control"name="name" placeholder="اسم الموظف" aria-describedby="basic-addon1"required>
                        ...
                        <div class="col-4">
                            ...
                            <button type="reset" class="btn btn-warning"><i class="fa-duotone fa-solid fa-xmark"></i></button>
                        </div>
                    </form>
                </div>
                            ...
                            @foreach (App\Models\Employee::all()->toArray() as $emp)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger"href="{{route('delete_employee',$emp['id'])}}"><i class="fa-regular fa-trash-can"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
...
<script>
    ...
    function update_dialog(emp){
        ...
        $("#id").val(emp.id);
        $(".dialog").dialog({height: 250,width:900,modal:true});
    }
</script>
